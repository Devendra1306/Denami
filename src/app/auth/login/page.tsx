  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-secondary/20 px-4 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-md bg-card/80 backdrop-blur-xl border border-border/50 rounded-3xl p-8 shadow-2xl relative z-10"
      >
        ...
        <p className="text-muted-foreground text-center mb-8">Sign in to your Denami Labs account</p>
